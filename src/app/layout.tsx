...
export const metadata: Metadata = {
  title: "Sana's Caffe | Artisan Coffee Downtown SF",  description: "Premium specialty coffee in downtown San Francisco. Single-origin roasts, expert baristas, and an elegant urban sanctuary for coffee lovers.",  keywords: ["specialty coffee", "downtown San Francisco", "artisan roasts", "third-wave coffee", "espresso bar"],
  openGraph: {
    title: "Sana's Caffe | Premium Specialty Coffee",    description: "Discover expertly crafted coffee and a luxury cafe experience in downtown SF",    siteName: "Sana's Caffe",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/breakfast-cafe-vertical-shot-steam-rises-cup-espresso-coffee-glass-water-cookies-table-closeup-sunlight-selective-focus-empty-space-idea-advertising-banner_166373-2884.jpg",        alt: "Sana's Caffe specialty coffee"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",    title: "Sana's Caffe | Artisan Coffee Downtown SF",    description: "Premium specialty coffee crafted by expert baristas",    images: ["http://img.b2bpic.net/free-photo/breakfast-cafe-vertical-shot-steam-rises-cup-espresso-coffee-glass-water-cookies-table-closeup-sunlight-selective-focus-empty-space-idea-advertising-banner_166373-2884.jpg"]
  },
  robots: {
    index: true,
    follow: true
